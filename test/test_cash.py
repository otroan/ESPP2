...
def test_cash():
    # Test cash
    return
    w = Wire(type=EntryTypeEnum.WIRE,
             date='2022-10-26',
             amount=Amount(currency='USD', value=-1000,
                           nok_value=-10000, nok_exchange_rate=9),
             fee=Amount(currency='USD', value=-15,
                        nok_value=-150, nok_exchange_rate=9),
    ...
    c.debit('2022-01-01', Amount(currency='USD', value=100,
            nok_value=1000, nok_exchange_rate=10))
    c.debit('2022-01-25', Amount(currency='USD', value=1000,
            nok_value=10000, nok_exchange_rate=11))
    # print('cash', c.cash)
    c.credit('2022-11-26', Amount(currency='USD', value=-10,
             nok_value=-1000, nok_exchange_rate=11), transfer=True)
    # c.credit('2022-11-26', Amount(currency='USD', value=-10,
