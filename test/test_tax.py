...
from espp2.datamodels import Transactions, Dividend, EntryTypeEnum, Amount, PositiveAmount, Deposit, Wire
...
def test_dividends(caplog):
    ...
    d = Dividend(type=EntryTypeEnum.DIVIDEND, date='2022-10-26', symbol='CSCO',
                 amount=PositiveAmount(currency='USD', value=38, nok_value=100, nok_exchange_rate=10),
                 source='test')
